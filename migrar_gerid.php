<?php
/**
 * Migração — Pesquisas de vínculo empregatício via GERID.
 *   curl -s "https://ferreiraesa.com.br/conecta/migrar_gerid.php?key=fsa-hub-deploy-2026"
 */

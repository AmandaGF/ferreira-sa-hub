...
$st = $pdo->prepare("SELECT id, name, cpf_cnpj, email, phone, created_at FROM clients WHERE name LIKE '%aline%' ORDER BY id");
$st->execute();
foreach ($st->fetchAll() as $r) {
    echo "  client_id={$r['id']} | {$r['name']} | cpf={$r['cpf_cnpj']} | created={$r['created_at']}\n";
}

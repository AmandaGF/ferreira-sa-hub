...
$_GET=array('gran'=>'mes','invmes'=>'2026-05'); $t0=microtime(true);
ob_start(); try{ require __DIR__.'/modules/whatsapp/conversas_novas.php'; $h=ob_get_clean();
  ...
  echo "tem seletor Tipo? ".(strpos($h,'name="inv_tipo"')!==false?'sim':'nao')."\n";
  echo "tem /dia no historico? ".(strpos($h,'/dia')!==false?'sim':'nao')."\n";

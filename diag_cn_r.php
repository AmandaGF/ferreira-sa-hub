...
foreach(array('dia','semana','mes') as $g){ $_GET=array('gran'=>$g,'key'=>'fsa-hub-deploy-2026'); ob_start(); try{ require __DIR__.'/modules/whatsapp/conversas_novas.php'; $h=ob_get_clean(); echo "[$g] OK ".strlen($h)."b\n"; }catch(Throwable $e){@ob_end_clean();echo "[$g] EXC ".$e->getMessage()." @ ".$e->getLine()."\n";} }

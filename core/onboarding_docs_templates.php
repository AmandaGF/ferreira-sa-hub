...
function render_contrato_prestacao_comercial($colaborador, $dadosAdmin, $dadosColab, $assinaturas = array()) {
    ...
    // 1. OBJETO
    $h .= '<div class="doc-clausula-titulo-h">CLÁUSULA 1ª — DO OBJETO E DO ESCOPO DOS SERVIÇOS</div>';
    $h .= '<div class="doc-clausula"><div class="doc-clausula-num">1.1</div><div class="doc-clausula-corpo">O presente contrato tem por objeto a prestação, pela ' . $rotuloParte . ', de serviços comerciais à CONTRATANTE — compreendendo prospecção, qualificação e atendimento de potenciais clientes, condução de tratativas pré-contratuais e apoio à conversão de propostas em contratos de honorários advocatícios —, em caráter autônomo e sem exclusividade.</div></div>';
    if ($escopo !== '') {
        $h .= '<div class="doc-clausula"><div class="doc-clausula-num">1.2</div><div class="doc-clausula-corpo">O escopo específico dos serviços compreende:<br><br><em>' . nl2br(htmlspecialchars($escopo)) . '</em></div></div>';
    } else {
        $h .= '<div class="doc-clausula"><div class="doc-clausula-num">1.2</div><div class="doc-clausula-corpo">Estão compreendidas no objeto, sem caráter exaustivo:<ul>'
            . '<li>prospecção e qualificação de potenciais clientes nos canais autorizados pela CONTRATANTE;</li>'
            . '<li>atendimento inicial e acolhimento de leads via WhatsApp, telefone, e-mail ou presencialmente;</li>'
            . '<li>esclarecimento de informações gerais sobre os serviços do escritório, sem caráter jurídico;</li>'
            . '<li>condução das tratativas comerciais e apresentação de propostas previamente aprovadas pela CONTRATANTE;</li>'
            . '<li>encaminhamento à equipe técnica para análise jurídica de cada caso;</li>'
            . '<li>acompanhamento do funil até a celebração do contrato de honorários;</li>'
            . '<li>registro das interações e propostas no F&amp;S Hub (Pipeline Comercial);</li>'
            . '<li>reuniões periódicas de alinhamento com a CONTRATANTE.</li>'
            . '</ul></div></div>';
    }
    $h .= '<div class="doc-clausula"><div class="doc-clausula-num">1.3</div><div class="doc-clausula-corpo">A ' . $rotuloParte . ' executará os serviços com autonomia técnica e organizacional, organizando seus próprios meios, métodos, locais e horário de trabalho. As atividades poderão ser realizadas em qualquer dia da semana, conforme a conveniência da ' . $rotuloParte . ', observados os prazos pactuados e as diretrizes institucionais da CONTRATANTE.</div></div>';
    $h .= '<div class="doc-clausula"><div class="doc-clausula-num">1.4</div><div class="doc-clausula-corpo">Sem prejuízo da autonomia prevista no item 1.3, as partes adotam, como referência operacional, o <strong>regime híbrido</strong> de prestação dos serviços, combinando atividades remotas e eventuais encontros presenciais no escritório ou em local indicado pela CONTRATANTE. <strong>As datas, a frequência e a forma dos encontros presenciais serão definidas pontualmente e de comum acordo entre as partes</strong>, conforme a conveniência e a disponibilidade da ' . $rotuloParte . ', não havendo dias fixos de comparecimento nem qualquer obrigação de presença mínima semanal ou mensal.</div></div>';
    if ($horasSemana > 0) {
        $h .= '<div class="doc-clausula"><div class="doc-clausula-num">1.5</div><div class="doc-clausula-corpo">Para fins de dimensionamento do escopo e da remuneração, as partes estimam que a execução dos serviços demandará da ' . $rotuloParte . ' cerca de <strong>' . $horasSemana . ' (' . htmlspecialchars(_onb_extenso_simples($horasSemana)) . ') horas por semana</strong>, cuja distribuição fica a critério da ' . $rotuloParte . '. Eventual variação para mais ou para menos não enseja revisão automática do contrato, salvo quando refletir alteração substancial e duradoura do escopo, hipótese em que as partes celebrarão aditivo.</div></div>';
    }
    $h .= '<div class="doc-clausula"><div class="doc-clausula-num">' . ($horasSemana > 0 ? '1.6' : '1.5') . '</div><div class="doc-clausula-corpo">A ' . $rotuloParte . ' compromete-se a manter disponibilidade razoável para o atendimento dos leads e demandas encaminhados pela CONTRATANTE, respondendo ao primeiro contato em prazo de até <strong>' . $tempoRespHrs . ' (' . htmlspecialchars(_onb_extenso_simples($tempoRespHrs)) . ') ' . ($tempoRespHrs === 1 ? 'hora útil' : 'horas úteis') . '</strong>, salvo período de indisponibilidade previamente comunicado.</div></div>';
    $h .= '<div class="doc-clausula"><div class="doc-clausula-num">' . ($horasSemana > 0 ? '1.7' : '1.6') . '</div><div class="doc-clausula-corpo">Por se tratar de atividade estritamente comercial, a ' . $rotuloParte . ' não está autorizada a: (i) prestar consultoria jurídica ou opinar sobre o mérito de causas; (ii) fixar honorários ou alterar valores previamente aprovados pela CONTRATANTE; (iii) celebrar contratos em nome do escritório sem autorização específica; (iv) representar a CONTRATANTE em juízo ou em órgãos públicos.</div></div>';

    // 2. NATUREZA JURÍDICA — concisa
    $h .= '<div class="doc-clausula-titulo-h">CLÁUSULA 2ª — DA NATUREZA CIVIL DO CONTRATO</div>';
    $h .= '<div class="doc-clausula"><div class="doc-clausula-num">2.1</div><div class="doc-clausula-corpo">O presente contrato é de natureza civil, regido pelos arts. 593 a 609 do Código Civil, e celebrado entre partes que atuam, cada qual, com autonomia em sua respectiva esfera de atividade econômica.</div></div>';
    $h .= '<div class="doc-clausula"><div class="doc-clausula-num">2.2</div><div class="doc-clausula-corpo">A ' . $rotuloParte . ' é responsável pelo recolhimento dos tributos e contribuições previdenciárias incidentes sobre a remuneração ora ajustada (IRPJ, CSLL, PIS, COFINS, ISS, INSS na qualidade de contribuinte individual e demais aplicáveis), assim como por suas obrigações acessórias junto aos órgãos competentes.</div></div>';

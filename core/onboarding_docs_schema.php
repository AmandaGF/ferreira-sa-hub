...
$ONBOARDING_DOC_SCHEMAS = array(
    ...
    'compromisso_estagio' => array(
        ...
        'campos_colaborador' => array(
            ...
            'rg' => array('label' => 'RG (número)', 'tipo' => 'text', 'obrigatorio' => true),
            'rg_orgao_uf' => array('label' => 'Órgão emissor / UF', 'tipo' => 'text', 'obrigatorio' => true, 'placeholder' => 'Ex: SSP/RJ'),
            'endereco_completo' => array('label' => 'Endereço completo (rua, nº, bairro, cidade/UF, CEP)', 'tipo' => 'text', 'obrigatorio' => true),
            'telefone' => array('label' => 'Telefone (com DDD)', 'tipo' => 'tel', 'obrigatorio' => true),
            ...
            'registro_academico' => array('label' => 'Registro acadêmico (RA)', 'tipo' => 'text', 'obrigatorio' => true),

...
$menuItems = array(
    ...
    array('label' => 'Rastreio de Cliques', 'icon' => '🔗', 'href' => url('modules/admin/shortlinks.php'), 'id' => 'shortlinks', 'roles' => $all, 'keywords' => 'shortlinks encurtador link tracking rastreio cliques abriu engajamento lead'),

...
var TEMPLATES = {
    informativo: '<div style="background:#052228;padding:24px;text-align:center;">'
        + '<img src="https://ferreiraesa.com.br/conecta/assets/img/logo.png" style="max-width:250px;" alt="Ferreira &amp; S\u00e1">'
        + '</div>'
        + '<div style="padding:24px 32px;font-family:Calibri,sans-serif;color:#1a1a1a;line-height:1.7;">'
        + '<h2 style="color:#052228;border-bottom:3px solid #B87333;padding-bottom:8px;">Informativo Jur\u00eddico</h2>'
        + '<p>Ol\u00e1, [nome]!</p>'
        + '<p>Escreva aqui o conte\u00fado do informativo...</p>'
        + '<p style="margin-top:24px;">Atenciosamente,<br><strong style="color:#052228;">Equipe Ferreira &amp; S\u00e1 Advocacia</strong></p>'
        + '</div>',
    felicitacoes: '<div style="background:linear-gradient(135deg,#052228,#0d3640);padding:32px;text-align:center;color:#fff;">'
        + '<div style="font-size:48px;margin-bottom:8px;">\ud83c\udf89</div>'
        + '<h1 style="margin:0;font-family:Calibri;color:#D7AB90;">Parab\u00e9ns!</h1>'
        + '</div>'
        ...
        + '<p>Desejamos um dia repleto de alegrias e realiza\u00e7\u00f5es!</p>'
        + '<p style="margin-top:24px;color:#B87333;font-weight:600;">Equipe Ferreira &amp; S\u00e1 Advocacia</p>'
        + '</div>',
    novidades: '<div style="background:#052228;padding:24px;text-align:center;">'
        + '<img src="https://ferreiraesa.com.br/conecta/assets/img/logo.png" style="max-width:250px;" alt="Ferreira &amp; S\u00e1">'
        + '</div>'
        + '<div style="padding:24px 32px;font-family:Calibri,sans-serif;color:#1a1a1a;line-height:1.7;">'
        + '<h2 style="color:#052228;">Novidades do Escrit\u00f3rio</h2>'
        + '<div style="background:#f8f8f6;border-left:4px solid #B87333;padding:16px;margin:16px 0;border-radius:0 8px 8px 0;">'
        + '<h3 style="margin:0 0 8px;color:#052228;">T\u00edtulo da not\u00edcia</h3>'
        + '<p style="margin:0;">Escreva aqui a novidade jur\u00eddica...</p>'
        + '</div>'
    ...
    pesquisa: '<div style="background:#052228;padding:24px;text-align:center;">'
        ...
        + '</div>'
        + '<div style="padding:24px 32px;font-family:Calibri,sans-serif;color:#1a1a1a;line-height:1.7;">'
        + '<h2 style="color:#052228;">Queremos ouvir voc\u00ea!</h2>'
        + '<p>Ol\u00e1, [nome]! Sua opini\u00e3o \u00e9 muito importante para n\u00f3s.</p>'
        + '<p>Responda nossa pesquisa r\u00e1pida (menos de 2 minutos):</p>'
        + '<div style="text-align:center;margin:24px 0;">'
        ...
        + '</div>'
        + '<p style="font-size:13px;color:#888;">Suas respostas s\u00e3o confidenciais.</p></div>',
    ...
    natal: '<div style="background:linear-gradient(135deg,#0a3d2e,#052228);padding:40px 24px;text-align:center;color:#fff;">'
        ...
        + '<p>Que este Natal traga paz, sa\u00fade e muitas b\u00ean\u00e7\u00e3os para voc\u00ea e sua fam\u00edlia.</p>'
        + '<p>Agradecemos pela confian\u00e7a depositada em nosso trabalho ao longo deste ano.</p>'
        + '<div style="margin:24px 0;padding:16px;background:#f8f5f0;border-radius:10px;border-left:4px solid #B87333;">'
        + '<p style="margin:0;font-style:italic;color:#052228;">Que o esp\u00edrito natalino ilumine seus caminhos e renove suas esperan\u00e7as.</p>'
        + '</div>'
        + '<p style="color:#B87333;font-weight:700;font-size:15px;">Equipe Ferreira &amp; S\u00e1 Advocacia</p>'
    ...
    ano_novo: '<div style="background:linear-gradient(135deg,#052228,#1a3a7a);padding:40px 24px;text-align:center;color:#fff;">'
        ...
        + '<div style="padding:32px;font-family:Calibri,sans-serif;color:#1a1a1a;line-height:1.8;text-align:center;">'
        + '<p style="font-size:16px;">Ol\u00e1, <strong>[nome]</strong>!</p>'
        + '<p>Desejamos um novo ano repleto de conquistas, sa\u00fade e prosperidade!</p>'
        + '<p>Agradecemos por fazer parte da nossa hist\u00f3ria. Seguimos juntos nessa caminhada.</p>'
        + '<div style="margin:24px 0;padding:16px;background:#f0f4ff;border-radius:10px;border-left:4px solid #1a3a7a;">'
        + '<p style="margin:0;font-style:italic;color:#052228;">Que 2027 seja o ano das grandes realiza\u00e7\u00f5es!</p>'
        + '</div>'
        + '<p style="color:#B87333;font-weight:700;font-size:15px;">Equipe Ferreira &amp; S\u00e1 Advocacia</p>'
        + '</div>',
    ...
    pascoa: '<div style="background:linear-gradient(135deg,#f5e6d3,#fff);padding:40px 24px;text-align:center;">'
        + '<div style="font-size:56px;margin-bottom:8px;">\ud83d\udc23</div>'
        + '<h1 style="margin:0;font-family:Calibri;color:#052228;font-size:28px;">Feliz P\u00e1scoa!</h1>'
        + '</div>'
        + '<div style="padding:32px;font-family:Calibri,sans-serif;color:#1a1a1a;line-height:1.8;text-align:center;">'
        + '<p style="font-size:16px;">Ol\u00e1, <strong>[nome]</strong>!</p>'
        + '<p>Que esta P\u00e1scoa renove suas esperan\u00e7as e traga momentos de uni\u00e3o com quem voc\u00ea ama.</p>'
        + '<div style="margin:24px 0;padding:16px;background:#fef9f0;border-radius:10px;border-left:4px solid #B87333;">'
        + '<p style="margin:0;font-style:italic;color:#052228;">A P\u00e1scoa nos lembra que sempre h\u00e1 renascimento ap\u00f3s os desafios.</p>'
        + '</div>'
        + '<p style="color:#B87333;font-weight:700;font-size:15px;">Equipe Ferreira &amp; S\u00e1 Advocacia</p>'
        + '</div>',
    ...
    dia_maes: '<div style="background:linear-gradient(135deg,#fce4ec,#fff);padding:40px 24px;text-align:center;">'
        + '<div style="font-size:56px;margin-bottom:8px;">\ud83d\udc90</div>'
        + '<h1 style="margin:0;font-family:Calibri;color:#052228;font-size:28px;">Feliz Dia das M\u00e3es!</h1>'
        + '</div>'
        + '<div style="padding:32px;font-family:Calibri,sans-serif;color:#1a1a1a;line-height:1.8;text-align:center;">'
        + '<p style="font-size:16px;">Ol\u00e1, <strong>[nome]</strong>!</p>'
        + '<p>Neste dia t\u00e3o especial, queremos homenagear todas as m\u00e3es que confiam em nosso trabalho.</p>'
        + '<p>Voc\u00eas s\u00e3o a for\u00e7a que move o mundo. Obrigado por nos permitir cuidar do que \u00e9 mais importante para voc\u00eas.</p>'
        + '<div style="margin:24px 0;padding:16px;background:#fdf2f8;border-radius:10px;border-left:4px solid #ec4899;">'
        + '<p style="margin:0;font-style:italic;color:#052228;">M\u00e3e: amor que protege, cuida e transforma.</p>'
        + '</div>'
        + '<p style="color:#B87333;font-weight:700;font-size:15px;">Equipe Ferreira &amp; S\u00e1 Advocacia</p>'
        + '</div>',
    ...
    dia_pais: '<div style="background:linear-gradient(135deg,#e3f2fd,#fff);padding:40px 24px;text-align:center;">'
        ...
        + '<p>Sabemos o quanto voc\u00ea se dedica. \u00c9 uma honra poder ajud\u00e1-lo nessa jornada.</p>'
        + '<div style="margin:24px 0;padding:16px;background:#eff6ff;border-radius:10px;border-left:4px solid #052228;">'
        + '<p style="margin:0;font-style:italic;color:#052228;">Pai: presen\u00e7a que faz toda a diferen\u00e7a.</p>'
        + '</div>'
        + '<p style="color:#B87333;font-weight:700;font-size:15px;">Equipe Ferreira &amp; S\u00e1 Advocacia</p>'
        + '</div>'
};
...
function atualizarPreview() {
    ...
    var rodape = '<div style="background:#052228;color:#fff;padding:16px;text-align:center;font-size:11px;font-family:Calibri;">'
        + '<p style="margin:4px 0;">Ferreira &amp; S\u00e1 Advocacia Especializada</p>'
        + '<p style="margin:4px 0;opacity:.6;">Rua Dr. Aldrovando de Oliveira, 140, Ano Bom, Barra Mansa/RJ</p>'
        + '<p style="margin:4px 0;"><a href="#" style="color:#D7AB90;">Cancelar inscri\u00e7\u00e3o</a></p></div>';
    doc.open();

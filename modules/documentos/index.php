...
$docTypes = array(
    ...
    'hipossuficiencia' => array('label' => 'Decl. Hipossuficiência', 'icon' => '📄', 'color' => '#d97706', 'desc' => 'Art. 98 CPC + Lei 1.060/50 — declaração assinada pelo cliente'),
    'gratuidade' => array('label' => 'Pet. Gratuidade de Justiça', 'icon' => '⚖️', 'color' => '#b45309', 'desc' => 'Petição da advogada pedindo deferimento da gratuidade — Art. 98 e seg. CPC + Art. 5º, LXXIV, CF'),

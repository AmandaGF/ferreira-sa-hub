        ...
        <div class="section">
            ...
            <div style="margin-bottom:.75rem;">
                ...
                <div style="display:flex;gap:.5rem;align-items:center;margin-bottom:.4rem;flex-wrap:wrap;">
                    <select id="motivoAudPreset" onchange="aplicarMotivoAudiencia(this.value)" style="flex:1;min-width:240px;padding:.45rem .6rem;border:1.5px solid #d1d5db;border-radius:8px;font-size:.85rem;background:#fff;">
                        ...
                        <option value="patrono_reside_interior_rj">🏡 Patrona reside no interior do RJ — dificuldade de deslocamento</option>
            ...
            (function() {
                var motivos = {
                    ...
                    patrono_reside_interior_rj: 'A patrona da Autora reside no interior do Estado do Rio de Janeiro, havendo significativa dificuldade de deslocamento até a Comarca onde tramita o feito, considerando-se a distância geográfica, o tempo de viagem e os custos envolvidos no deslocamento. Tal circunstância dificulta o pleno exercício dos princípios constitucionais da ampla defesa e do contraditório (art. 5º, LV, da CF/88), na medida em que onera desproporcionalmente o patrocínio efetivo da causa e compromete a disponibilidade da advogada para o adequado acompanhamento do ato. A designação da audiência em modalidade remota ou, alternativamente, híbrida, mostra-se medida proporcional e adequada à preservação da defesa técnica integral da parte, sem qualquer prejuízo à oralidade, à imediação ou ao regular exercício do contraditório, com pleno respaldo no art. 236, §3º, do CPC e na Resolução nº 354/2020 do CNJ.',

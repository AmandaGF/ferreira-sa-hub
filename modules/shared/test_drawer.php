...
h+='<div class="cs"><h5>Contrato</h5>'+R('Honorários (R$)',l.honorarios_cents?'R$ '+(l.honorarios_cents/100).toLocaleString('pt-BR',{minimumFractionDigits:2}):l.valor_acao)+R('Êxito (%)',l.exito_percentual?l.exito_percentual+'%':null)+R('Forma Pgto',l.forma_pagamento)+R('Vencimento',l.vencimento_parcela)+R('Pasta',l.nome_pasta)+R('Pendencias',l.pendencias)+R('Convertido',l.converted_at?FD(l.converted_at):null)+'</div>';

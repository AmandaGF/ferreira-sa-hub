...
.kanban { display:flex !important; flex-direction:row !important; gap:.75rem; overflow-x:auto; padding-bottom:1rem; min-height:500px; }
.kanban-col { min-width:220px; max-width:260px; flex:1; flex-shrink:0; display:flex; flex-direction:column; }

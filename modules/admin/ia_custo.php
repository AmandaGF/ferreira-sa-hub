...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validate_csrf()) {
        ...
        $feats = array('resumo_caso','classif_andamento','cliente_esfriando','sugerir_acao','briefing','resumo_wa_chamado',
                       ...
                       'chat_caso',
                       // Fase 6 — oficio de desconto folha auto pos-GERID (09/07/2026)
...
// Fase 5 — DEFAULT OFF (chat IA do processo — Haiku ~R$0,03/pergunta, Sonnet ~R$0,20 só Amanda)
$featChatC  = cfg($pdo, 'ia_feature_chat_caso_enabled', '0') === '1';
// Fase 6 — DEFAULT OFF (Sonnet + web_search — ~R$0,15-0,30 por oficio gerado)
$featGeridOf = cfg($pdo, 'ia_feature_gerid_oficio_desconto_enabled', '0') === '1';
    ...
    <div style="margin-bottom:1rem;">
        ...
        <div style="margin-top:.8rem;padding:.7rem;background:#fef9c3;border:1px solid #fde68a;border-radius:6px;">
            ...
            <div style="display:flex;gap:.6rem;flex-wrap:wrap;">
                ...
                <label style="display:flex;align-items:center;gap:.4rem;background:#fff;border:1px solid #fde68a;padding:.4rem .7rem;border-radius:6px;font-size:.85rem;cursor:pointer;" title="Chat de perguntas pontuais sobre o processo dentro da ficha do caso. Haiku pra todos os autorizados; Sonnet (modo aprofundado) só pra Amanda.">
